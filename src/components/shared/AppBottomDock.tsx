...
export function AppBottomDock({ children }: AppBottomDockProps) {
  return (
    <div className="relative w-full z-[100] pointer-events-auto shrink-0 bg-[rgba(250,251,247,0.86)] backdrop-blur-[18px] border-t border-[rgba(214,222,229,0.6)] shadow-[0_-4px_18px_rgba(99,117,135,0.05)] [padding-bottom:max(calc(env(safe-area-inset-bottom)-14px),0px)]">
