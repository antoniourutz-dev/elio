  ...
  return (
    <section className="grid gap-5 rounded-[32px] border border-[rgba(216,226,241,0.88)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(247,251,255,0.96))] p-6 shadow-[0_18px_48px_rgba(110,130,150,0.08)]">
      <div className="grid gap-2">
        ...
        <h2 className="m-0 font-display text-[clamp(1.9rem,4vw,2.7rem)] leading-[0.94] tracking-[-0.05em] text-[#203143]">
          Atal hau prestatzen ari gara
        </h2>
        <p className="m-0 max-w-[34rem] text-[0.96rem] font-medium leading-relaxed text-[#708596]">{body}</p>
      </div>
      ...
      <div className="grid gap-4 rounded-[28px] border border-[rgba(145,195,214,0.26)] bg-[linear-gradient(135deg,rgba(121,183,223,0.14),rgba(226,240,184,0.26))] p-5">
        <div className="flex items-center gap-3">
          ...
          <span className="inline-flex min-h-[34px] items-center rounded-full bg-[rgba(255,255,255,0.74)] px-3 text-[0.78rem] font-extrabold uppercase tracking-[0.1em] text-[#648199]">
            Laster hemen
          </span>
        </div>
        ...
        <div className="rounded-[22px] border border-dashed border-[rgba(112,146,170,0.26)] bg-[rgba(255,255,255,0.7)] p-4">
          <div className="flex items-start gap-3">
            <Construction className="mt-0.5 h-5 w-5 shrink-0 text-[#6d89a0]" />
            <p className="m-0 text-[0.94rem] font-semibold leading-relaxed text-[#5f7486]">
